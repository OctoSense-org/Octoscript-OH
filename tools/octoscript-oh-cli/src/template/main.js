...
// window.octoscript comes from /__octoscript.js. Every native call goes through it and
// every one returns a promise.
const call = (tool, args) => window.octoscript.invoke(tool, args)

const app = document.querySelector('#app')
app.innerHTML = `
  <h1>My Octoscript App</h1>
...
// edits in the Octoscript-OH checkout; see "Add a native capability" in README.md.
