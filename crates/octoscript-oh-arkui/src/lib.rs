//! Octoscript DSL rendered to OpenHarmony **native ArkUI widgets**, with no ArkTS
//! in the loop.
//!
...
//! native capability tools live in `octoscript-oh-webview`, which depends on this
